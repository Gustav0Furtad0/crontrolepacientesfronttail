...
export default function AddPatientModal({ onClose }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(formData); // Aqui você pode substituir pelo método de enviar os dados para o seu backend
            ...
            <div className="bg-white rounded shadow-lg w-1/2">
                ...
                <form onSubmit={handleSubmit} className="p-4">
                    <div className="mb-4">
                        ...
                        <input type="text" name="nomeCompleto" id="nomeCompleto" onChange={handleChange} value={formData.nomeCompleto} required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                    </div>
                    <div className="mb-4">
